...
// Closed-loop State Sensing: D1 (GPIO 5) reads lamp standby/night indicator LED anode.
// When Lamp is OFF: Standby LED is lit (measured 2.6V) -> digitalRead(5) == HIGH.
// When Lamp is ON:  Standby LED is dark (0V)           -> digitalRead(5) == LOW.
const uint8_t PIN_STATE_SENSE = 5; // D1 / GPIO5
